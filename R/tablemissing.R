...
plot(10,20, type="n", xlim=c(0,120), ylim=c(0,pylim), axes=FALSE, xlab="", ylab="", main="Missing Value Plot")
...
legend(bx1,0, names(finaltable)[i],bty="n", xjust=0, yjust=0.5, x.intersp=-1)
bx1=bx1+width
bx2=bx1+width/2
}
